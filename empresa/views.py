...
def nova_empresa(request):
    if request.method == "GET":
        ...
        nichos0 = [i[0] for i in Empresa.choices_nicho_mercado]
        nichos1 = [i[1] for i in Empresa.choices_nicho_mercado]
        nichos = zip(nichos0, nichos1)
        return render(
            request,
            "nova_empresa.html",
            {"techs": techs, "nichos": nichos},
        )
...
def empresas(request):
    ...
    return render(
        request, "empresa.html", {"empresas": empresas, "tecnologias": tecnologias}
    )
